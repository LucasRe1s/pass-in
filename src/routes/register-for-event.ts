    ...
    app
        ...
        .post('/events/:eventId/attendees', {
            ...
            if (event?.maximumAttendees && amountAttendeesForEvent >= event.maximumAttendees) {
                ...
                throw new BadRequest("the maxime number of attendees for this event has ben reached")
            }
            ...
            return reply.status(201).send({ atteendeeId: attendee.id })
        })
}